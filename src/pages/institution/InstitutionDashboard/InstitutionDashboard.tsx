...
export const InstitutionDashboard: React.FC = () => {
  ...
  const institutionFeatures = [
    {
      ...
      description: 'Manage student and teacher accounts, assign roles',
      status: 'Coming Soon',
      color: 'bg-primary',
    },
    {
      ...
      description: 'Monitor all projects across departments',
      status: 'Coming Soon',
      color: 'bg-secondary',
    },
    {
      ...
      description: 'Create and manage institution hackathons',
      status: 'Coming Soon',
      color: 'bg-purple-500',
    },
    {
    ...
    },
    {
      ...
      description: 'Send announcements and manage chat channels',
      status: 'Coming Soon',
      color: 'bg-green-500',
    },
    {
      ...
      description: 'Configure institution-wide policies and settings',
      status: 'Coming Soon',
      color: 'bg-card',
    },
  ];
  ...
  return (
    <div className="space-y-6 w-full p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardBody className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-muted-foreground">Upcoming Hackathons</p>
      ...
      <div>
        <h2 className="text-2xl font-bold text-foreground mb-6">Institution Features</h2>
        ...
        <CardBody>
          <div className="space-y-4">
            {[
              ...
              { action: 'Teacher assigned', user: 'Dr. Smith to Web Dev Project', time: '3 hours ago', type: 'mentor' },
            ].map((activity, index) => (
